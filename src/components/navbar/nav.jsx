...
//     console.log("Item:", item); // See what's causing the issue
  ...
  const handleScrollToTop = () => {
    ...
    return(
        <div className=" nn container " >
            <div className="logo">
            <Link  onClick={handleScrollToTop} to={"/"}><img src={img} alt="" /></Link>
            </div>
            ...
            <div className="icon">
            <div className="drop">
                <Link  onClick={handleScrollToTop} to={'/cartpage2'} class="btn btn-success"><i class="fa-solid fa-suitcase"></i></Link>
...
<div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
  ...
  <ul>
                <li>       <Link  onClick={handleScrollToTop}  to="/"  className='mm'>Home</Link></li>
                <li>       <Link  onClick={handleScrollToTop} to="/توابل"  className='mm'>Concentrated spices (powder)</Link></li>
                <li>       <Link  onClick={handleScrollToTop} to="/صوصات" className='mm'>Sauces and Cheeses (Powder)</Link></li>
                <li>       <Link  onClick={handleScrollToTop} to="/النكهات المركزة بودر"  className='mm'>Concentrated Flavors (Powder)</Link></li>
                <li>       <Link  onClick={handleScrollToTop} to="/النكهات المركزة زيوت"  className='mm'>Concentrated Flavors (oils)</Link></li>
                <li>       <Link  onClick={handleScrollToTop} to="/خلطات توابل مركزة"  className='mm'>Concentrated Spice Mixes</Link></li>
                <li>       <Link  onClick={handleScrollToTop} to="/منتجات حلول وتقنية الأغذية"  className='mm'>Food Solutions and Technology Products</Link></li>
                <li>       <Link  onClick={handleScrollToTop} to="/contact"  className='mm'>Contact Us</Link></li>
                </ul>
                </div>
  </div>
</div>
